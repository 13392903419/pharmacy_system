...
-- 插入药品数据
INSERT
INTO medicine (medicine_code, medicine_name, specification, manufacturer, unit, price)
VALUES
    ('M001', '阿莫西林胶囊', '0.25g*24粒/盒', '哈药集团制药总厂', '盒', 15.80),
    ('M002', '布洛芬片', '0.2g*24片/盒', '上海信谊药厂', '盒', 12.50),
    ('M003', '感冒灵颗粒', '10g*10袋/盒', '白云山制药', '盒', 25.00),
    ('M004', '维生素C片', '0.1g*100片/瓶', '北京同仁堂', '瓶', 18.50),
    ('M005', '板蓝根颗粒', '10g*20袋/盒', '广州白云山', '盒', 22.00),
    ('M006', '复方丹参片', '0.32g*36片/盒', '天津天士力', '盒', 28.50),
    ('M007', '藿香正气水', '10ml*10支/盒', '云南白药', '盒', 16.80),
    ('M008', '金银花露', '10ml*10支/盒', '广州白云山', '盒', 14.50),
    ('M009', '六味地黄丸', '200丸/瓶', '北京同仁堂', '瓶', 35.00),
    ('M010', '牛黄解毒片', '0.3g*24片/盒', '天津天士力', '盒', 12.80);
...
ALTER TABLE MEDICINE DROP COLUMN stock_quantity;