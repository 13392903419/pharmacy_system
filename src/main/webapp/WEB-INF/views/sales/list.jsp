...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="${pageContext.request.contextPath}/sales" class="active"><i class="ri-shopping-cart-fill"></i>销售管理</a></li>
    ...
    <div class="main-content">
        ...
        <div class="card" style="margin-bottom: 24px;">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/sales" method="get" style="display: flex; gap: 12px; max-width: 400px;">
                    <input type="text" name="keyword" class="form-control" placeholder="搜索销售单号、客户或员工..." value="${keyword}" style="flex: 1;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach items="${salesList}" var="order">
                                <tr>
                                    <td style="font-weight: 500; color: var(--primary-color);">${order.salesCode}</td>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            ...
                                            <a href="${pageContext.request.contextPath}/sales/delete/${order.salesId}"
                                               class="btn btn-sm btn-danger"
                                               onclick="return confirm('确定要删除销售单【${order.salesCode}】吗？此操作不可恢复！')"
                                               title="删除销售单">
                            ...
                            <c:if test="${empty salesList}">
                                <tr>
                                    <td colspan="7" style="text-align: center; padding: 60px; color: var(--text-secondary);">
                                        <i class="ri-shopping-cart-line" style="font-size: 48px; color: var(--text-secondary); margin-bottom: 16px;"></i>
                                        <br>暂无销售数据
                                        <br><small>点击"新增销售单"开始记录销售信息</small>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
                ...
                <!-- 分页 -->
                <c:if test="${not empty salesList && totalPages > 1}">
                    <div class="pagination">
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a class="page-link ${i == page ? 'active' : ''}" href="${pageContext.request.contextPath}/sales?page=${i}&keyword=${keyword}">${i}</a>
                        </c:forEach>
                    </div>
                </c:if>
            </div>
