...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="${pageContext.request.contextPath}/medicine" class="active"><i class="ri-medicine-bottle-fill"></i>药品管理</a></li>
    ...
    <div class="main-content">
        ...
        <div class="card" style="margin-bottom: 24px;">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/medicine/search" method="get" style="display: flex; gap: 12px; max-width: 400px;">
                    <input type="text" name="keyword" class="form-control" placeholder="搜索药品名称、编码或厂家..." style="flex: 1;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach items="${medicines}" var="medicine">
                                <tr>
                                    <td style="font-weight: 500; color: var(--primary-color);">${medicine.medicineCode}</td>
                                    <td style="font-weight: 500;">${medicine.medicineName}</td>
                                    <td>${medicine.specification}</td>
                                    <td>${medicine.manufacturer}</td>
                                    <td>${medicine.unit}</td>
                                    <td style="font-weight: 600; color: var(--success-color);">￥${medicine.price}</td>
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            ...
                                            <a href="${pageContext.request.contextPath}/medicine/delete/${medicine.medicineId}"
                                               ...
                                               onclick="return confirm('确定要删除药品【${medicine.medicineName}】吗？此操作不可恢复！')"
                                               title="删除药品">
                            ...
                            <c:if test="${empty medicines}">
                                <tr>
                                    <td colspan="7" style="text-align: center; padding: 60px; color: var(--text-secondary);">
                                        <i class="ri-medicine-bottle-line" style="font-size: 48px; color: var(--text-secondary); margin-bottom: 16px;"></i>
                                        <br>暂无药品数据
                                        <br><small>点击"添加药品"开始管理您的药品库存</small>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
