    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/inventory/save" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>数量</label>
                    <input type="number" name="quantity" value="${inventory.quantity}" required min="0">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" required>
                    <option value="normal" ${inventory.status == 'normal' ? 'selected' : ''}>正常</option>
                    <option value="low" ${inventory.status == 'low' ? 'selected' : ''}>库存不足</option>
                    <option value="expired" ${inventory.status == 'expired' ? 'selected' : ''}>已过期</option>
                </select>
            </div>
